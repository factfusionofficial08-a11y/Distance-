...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const cardsData = [
        ...
        { file: '05card.png', imgSrc: './fonts/cardnw.png', title: 'Hint', text: 'A rose. A blood stain.One represents love.The other hides a name.Look closely.Can you identify the person?' },
